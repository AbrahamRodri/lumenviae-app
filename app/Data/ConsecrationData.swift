...
enum ConsecrationData {
    ...
    /// The prayers of the consecration that exist in English alone —
    /// Montfort's own prayers, written in French and never given a
    /// liturgical Latin, the Litany of the Holy Ghost of his plan (a
    /// private litany with no received Latin text; none has been
    /// invented for it), the Act of Consecration itself — keyed by ID.
    /// The prayers with Latin live in `BilingualConsecrationPrayers`.
    ///
    /// Set in the grammar `PrayerText` reads: ℣ ℟ in red, a litany's
    /// response stated once at the head of each group after its ℟ and
    /// answered to every line beneath, "[Let us pray.]" as a rubric,
...
Amen, so be it — to all that thou art doing in my soul,
so that thou alone mayest fully glorify Jesus in me for time and eternity.
...
Ah, would that I could proclaim throughout the whole world the mercy that Thou hast shown to me! Would that everyone might know I should be already damned, were it not for Mary! Would that I might offer worthy thanksgiving for so great a blessing!

Mary is in me. Oh, what a treasure! Oh, what a consolation! And shall I not be entirely hers? Oh, what ingratitude! My dear Saviour, send me death rather than such a calamity, for I would rather die than live without belonging entirely to Mary.
...
O Holy Spirit, give me great devotion to Mary, Thy faithful Spouse; give me great confidence in her maternal heart and an abiding refuge in her mercy, so that by her Thou mayest truly form in me Jesus Christ, great and mighty, unto the fullness of His perfect age.
...
"""
        ...
        "rosary": ConsecrationPrayer(
            ...
            latinTitle: "Sanctíssimum Rosárium",
            content: """
[Pray at least five decades of the Rosary, meditating on the mysteries appointed for the day.]

[The Rosary is prayed from Home, or with the Pray button, with a meditation on each mystery.]
"""
        )
    ]

    /// Get prayers for a specific phase, in English.
    ///
    /// Reaches through the language lookup so the bilingual prayers —
    /// the hymns, the canticle, two of the litanies — are not silently
    /// dropped for living in the other store.
    static func prayers(for phase: ConsecrationPhase) -> [ConsecrationPrayer] {
        prayers(for: phase, language: .english)
    }

    /// Get a specific prayer by ID, in English
    static func prayer(_ id: String) -> ConsecrationPrayer? {
        BilingualConsecrationPrayers.allPrayers[id]?.toConsecrationPrayer(for: .english)
            ?? allPrayers[id]
    }
...
""",
                ...
                ConsecrationReading(
                    order: 2,
                    title: "Guidance for the Twelve Days",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 3, Chapters 7 & 40",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 3, Chapter 40",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 18",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 18 (cont.)",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 13",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 13 (cont.)",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 3, Chapter 10",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 25",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 25 (cont.)",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Theme for the Week: Knowledge of Self",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 3, Chapter 13",
                    text: """
...
""",
                ...
                ConsecrationReading(
                    order: 2,
                    title: "Imitation of Christ, Book 2, Chapter 5",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 24",
                    text: """
...
""",
                ...
                ConsecrationReading(
                    order: 2,
                    title: "Imitation of Christ, Book 3, Chapter 47",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Theme for the Week: Knowledge of the Blessed Virgin",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "The Secret of Mary, Nos. 23-24",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "True Devotion, Nos. 106-110",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "True Devotion, Nos. 120-121",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "True Devotion, Nos. 152-164",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "True Devotion, Nos. 213-225",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Theme for the Week: Knowledge of Jesus Christ",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Matthew 26:1-2, 26-29, 36-46",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 1, Chapter 1",
                    text: """
...
""",
                ...
                ConsecrationReading(
                    order: 2,
                    title: "Imitation of Christ, Book 2, Chapter 12",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 4, Chapter 2",
                    text: """
...
""",
                ...
                ConsecrationReading(
                    order: 2,
                    title: "True Devotion, Nos. 243, 245-246, 249",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 2, Chapter 7",
                    text: """
...
""",
                ...
                ConsecrationReading(
                    order: 2,
                    title: "True Devotion, Nos. 257-260",
                    text: """
...
""",
        ...
        allDays.append(ConsecrationDay(
            ...
            readings: [
                ConsecrationReading(
                    order: 1,
                    title: "Imitation of Christ, Book 4, Chapter 11",
                    text: """
